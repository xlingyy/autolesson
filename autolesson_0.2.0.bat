...
echo %dow% | findstr "1" && goto Monday || echo %dow% | findstr "2" && goto Tuesday || echo %dow% | findstr "3" && goto Wednesday || echo %dow% | findstr "4" && goto Thursday || echo %dow% | findstr "5" && goto Friday || goto unsuccessful
